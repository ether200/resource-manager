...
export const createResource =
  (resource: ResourceCreateInterface) =>
...
export const editResource =
  (resource: ResourceFormValues, resourceId: string) =>
  async (dispatch: Dispatch<ResourceDispatchTypes>) => {
    try {
...
export const deleteResource =
  (resourceId: string) => async (dispatch: Dispatch<ResourceDispatchTypes>) => {
    try {
...
export const selectResourceToEdit =
